...
<div id="sub_container">
	...
	<div class="path">
		<ul class="depth">
			...
			<li class="depth_sub"><a href="javascript:void('0')">LG히다찌</a>
				<ul>
			...
			<li class="depth_sub2"><a href="javascript:void('0')">올플래시 스토리지</a>
				<ul>
			...
			<input type="hidden" id="pageIndex" name="pageIndex" value="1">
				<div class="procure_hd pro_bg05">
					...
					<div class="conts">
						...
						<div class="conts_in">
							빅데이터, 클라우드, IoT의 확산으로 데이터는 어느 때와도 비교할 수 없을 정도로 매우 급증하고 있습니다. 이처럼 기업용 스토리지 시스템 시장은 꾸준히 성장하고 있습니다. Hitachi Data Systems 제품은 하이엔드 시장에서 1위를 기록하며, 최신 트렌드의 핵심제품과 솔루션을 제공합니다. 
						</div>
					</div>
					<div class="btn_wr">
