...
<div id="sub_container">
	...
	<div class="path">
		<ul class="depth">
			...
			<li class="depth_sub"><a href="javascript:void('0')">알티베이스</a>
				<ul>
			...
			<input type="hidden" id="pageIndex" name="pageIndex" value="1">
				<div class="procure_hd pro_bg07">
					...
					<div class="conts">
						...
						<div class="conts_in">
							ALTIBASE HDB DBMS는 In-Memory DBMS와 On-Disk DBMS가 하나의 통합 엔진에서 관리되는 구조로, 고성능 처리가 요구되는 데이터는 In-Memory DBMS에서 관리하고, 대량의 데이터 관리는 On-Disk DBMS 에서 관리하는 유연성을 제공하는 DBMS입니다.
						</div>
					</div>
					<div class="btn_wr">
