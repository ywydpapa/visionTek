...
<div id="sub_container">
	...
	<div class="path">
		<ul class="depth">
			...
			<li class="depth_sub2"><a href="javascript:void('0')">DB방화벽</a>
				<ul>
	...
	<div id="sub_middle">
		<h3 class="ctle">DB방화벽</h3>
		
		<!--컨텐츠 S-->
		<div class="contents">
			<div class="innerwrap">
			<form id="boardFrm" action="<c:url value='/procure/procure01_2'/>" method="post" >
            <input type="hidden" id="pageIndex" name="pageIndex" value="1">
				<div class="procure_hd">
					<h3>APPLICATION INSIGHT DFW</h3>
					<p class="stxt">Intelligent Database Access Control <span>APPLICATION INSIGHT DFW</span></p>
					<div class="conts">
						<div class="title">
							<p>What is<br> APPLICATION INSIGHT DFW?</p>
						</div>
						<div class="conts_in">
							APPLICATION INSIGHT DFW는 완전한 Query분석을 기반으로 사용자 기반의 강력한 권한제어 및 접근제어, profile기반의 자동화된 보안 정책을 제공함으로서 외부로 부터의 비정상적인 DB접근을 통제하고, 접근이력 관리를 통한 사후 감사기능으로 주요 내부 정보 자산을 보호해주는 전용DB방화벽 제품입니다. 
						</div>
					</div>
					<div class="btn_wr">
